...
for(( i = 0 ; i < 8; i++)) ; do
#	perf stat -C 0 -e offcore_response.any_request.mcdram_near,offcore_response.any_request.mcdram_far,offcore_response.any_request.ddr_near,offcore_response.any_request.ddr_far numactl --membind 0-3 ./test $@
